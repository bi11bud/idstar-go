...
func InitDB() {
	...
	err = db.AutoMigrate(
		&model.DetailKaryawanEntity{},
		&model.RekeningEntity{},
		&model.KaryawanTrainingEntity{},
		&model.TrainingEntity{},
		&model.KaryawanEntity{},
	)

	if err != nil {
		log.Fatal("Error when open migrate table to database: ", err.Error())
		panic(err)
	}
